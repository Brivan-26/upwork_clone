...
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    @csrf
    <div class="mb-4">
        <label for="name" class="block font-semibold text-gray-700 mb-2">User name</label>
    ...
    <div class="mb-4">
        <label for="password_confirmation" class="block font-semibold text-gray-700 mb-2">Confrim password</label>
    ...
    <p for="role-select" class="font-semibold text-gray-700">I'am  :</p>
    <div class="flex justify-between items-center">
        <label for="freelance">Freelancer
            <input type="radio" value="1" id="freelancer" name="role_id">
    ...
    <button type="submit" class="bg-green-500 text-white hover:bg-green-700 transition ease-in-out duration-500 rounded-md shadow-md w-full block px-4 py-2 mt-3">Create</button>
</form>
@endsection